...
чем произведение чисел по периметру области 3, то поменять в В симметрично области 1 и 3 местами, иначе С и В поменять местами несимметрично. 
...
def is_simple_number(x):
    ...
    while divider < (x**0.5):
        ...
        divider += 1
    return True
# это все равно, что игру какую-нибудь в футболе да купили и всем рассказали какой счет будет... АХАХАХАХАХА
